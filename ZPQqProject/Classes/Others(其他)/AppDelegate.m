...
- (BOOL)application:(UIApplication *)application willFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    QQMenuViewController * leftSideDrawerViewController = [[QQMenuViewController alloc] init];
    QQMainTabbarController * centerViewController = [[QQMainTabbarController alloc] init];
    ...
    [leftSideDrawerViewController setRestorationIdentifier:@"MMLeftNavigationControllerRestorationKey"];
